...
class Application(models.Model):
    ...
    slug = models.SlugField(unique=True, blank=True, verbose_name="Slug (URL)")
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, blank=True, limit_choices_to={'type': 'application'}, verbose_name="Catégorie")
    platform = models.CharField(max_length=20, choices=PLATFORM_CHOICES, default='web', verbose_name="Plateforme / Format")
    version = models.CharField(max_length=30, default="v1.0.0", blank=True, verbose_name="Version")
    icon = models.CharField(max_length=50, default="layout", help_text="Nom de l'icône Lucide (ex: layout, smartphone, monitor, cloud, cpu, box, shield, code)", verbose_name="Icône Lucide")
    short_description = models.TextField(verbose_name="Résumé court")
    full_description = models.TextField(blank=True, verbose_name="Description détaillée & Fonctionnalités")
    tech_stack = models.CharField(max_length=255, blank=True, help_text="Séparées par des virgules (ex: Python, Django, React, Flutter, PostgreSQL)", verbose_name="Stack Technique")
    image_url = models.CharField(max_length=500, blank=True, verbose_name="URL de l'image / Screenshot")
    ...
    badge = models.CharField(max_length=50, blank=True, help_text="ex: En Production, Beta, SaaS Multi-Tenant, Gratuit", verbose_name="Badge / Tag")
